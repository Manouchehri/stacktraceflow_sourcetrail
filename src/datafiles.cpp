...
#include <tuple>
#include <fstream> // TODO: move to FILE*
#include <regex>
#include <cstdio>
#include <endian.h>
...
static void readDirectoryFile(const std::string& path) {
...
static void parseFunctionCall(std::ifstream &recordStream, FuncCall &parent) {
    uint32_t funcNumber;
